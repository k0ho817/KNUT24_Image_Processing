...
from PySide6.QtWidgets import (QApplication, QComboBox, QHBoxLayout, QLabel, QMainWindow, QPushButton, QVBoxLayout, QWidget, QLineEdit, QSizePolicy, QGridLayout, QRadioButton)
...
class Window(QMainWindow):
    ...
    def load_img_func(self):
        if self.radio_image.isChecked() is True:
            ...
            self.m_main_img = cv2.resize(self.m_main_img, (self.img_size.width(), self.img_size.height()), interpolation=cv2.INTER_CUBIC)
